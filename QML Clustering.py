...
# (unfortunately we ran out of time so we had to hard code in data, so that it would match the data given to the classical ML) We created a function that calculates the distance between two points.
